...
int potentiometerPin3 = 20; //Change "?" to the pin your potentiometer is connected to
int potentiometerPin4 = 21;

const bool initAutoSendState = true;


//BUTTON SINGLE
#define NUMSINGLEBUTTON 4
byte buttonPins[NUMSINGLEBUTTON] = {10, 14, 15, 16};
int lastButtonState[NUMSINGLEBUTTON] = {0, 0, 0, 0};
int firstSingleButton = 16;
...
void CheckAllButtons(void) {
  ...
  for (int index = 0; index < NUMSINGLEBUTTON; index++)
  {
    ...
    {
      Joystick.setButton(firstSingleButton + index, currentButtonState);
